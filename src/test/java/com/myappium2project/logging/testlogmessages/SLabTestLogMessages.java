...
public class SLabTestLogMessages {
    ...
    public static final String CART_EMPTY_VALIDATION_ASSERTLOG = "The cart should be empty, but it is not.";
    ...
    public static final String CART_COUNTER_AVAILABLE_VALIDATION_ASSERTLOG = "The cart counter should not be available, but it is.";

    public static String getPageTitleValidationAssertLog(String expectedPageTitleText) {
